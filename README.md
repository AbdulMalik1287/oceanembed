...
reaches the working grid by an exact integer-factor area-mean coarsen with **no interpolation**, which keeps the land mask crisp. Only GLORYS (1/12°, origin 4.5) is offset and needs an interp.
